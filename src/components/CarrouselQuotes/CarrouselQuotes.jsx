...
export default function CarrouselQuotes() {
  ...
  return (
    <section className="c-quotes-cont">
      ...
      <i onClick={() => reactSwipeEl.prev()} className="action-btn btn-prev fa-solid fa-circle-arrow-left"></i>
      <i onClick={() => reactSwipeEl.next()} className="action-btn btn-next fa-solid fa-circle-arrow-right"></i>
