    ...
    <main className="counseling-cont container">
      ...
      <div className="counseling-info-cont">
        <div className="counseling-text-cont">
          <p>
            El <span className="negritas">Counseling</span> es una profesión
            para el desarrollo y el despliegue de las capacidades y las
            potencialidades del ser humano y para su bienestar.
          </p>
          <p>
          ...
          <p>
            <span className="negritas">
              La finalidad es el bienestar de la persona
            </span>{" "}
            y que en el avance del proceso pueda:{" "}
            <span className="negritas">
              reconocerse a sí misma con sus necesidades
            </span>{" "}
            y hacer frente a ellas, poniendo al servicio sus recursos internos y
            ...
            , sus vínculos, sus relaciones con el mundo;{" "}
            <span className="negritas">
              desenvolverse creativamente; habilitarse a transitar la vida
              desplegando todo su ser
            </span>
            , deseando, sintiendo, pensando, haciendo, creando.
          </p>
          <p>
            Como counselor{" "}
            <span className="negritas">
              puedo ofrecer una invitación a habitar un espacio de escucha de lo
              que esté atravesando la persona en el momento presente
            </span>
            . Para que se permita expresar en un ambiente de seguridad, de
            respeto, de comprensión.
          </p>
          <p>
          ...
          <p>
            Desde el counseling{" "}
            <span className="negritas">
              realizamos un acompañamiento de la persona, como una realidad
              compleja y única, intentando acercarnos a su vivencia particular
            </span>
            . Y desde este lugar trabajamos con ella, en las necesidades que
            fueran surgiendo durante el proceso.
          </p>
          <p>
      ...
      <section className="temas-counseling-cont">
        ...
        <ul className="temas-counseling-list d-flex">
          <li className="pe-1">
            Etapas vitales<span className="counseling-guion"> - </span>
          </li>
          <li className="pe-1">
            Identidad<span className="counseling-guion"> - </span>
          </li>
          <li className="pe-1">
          ...
          <li className="pe-1">
            Adicciones<span className="counseling-guion"> - </span>
          </li>
          <li className="pe-1">
      ...
      <section className="pilares-cont">
        ...
        <div className="pilares-list">
          <ul className="mb-4">
            ...
            <li>
              <span className="negritas">Proceso personal:</span> en el que nos
              acercamos a una comprensión de nosotros mismos y trabajamos
              profundamente la autorrealización.
            </li>
            <li>
              <span className="negritas">Supervisión del trabajo:</span>{" "}
              mediante la cual revisamos e integramos nuestro ser personal,
              nuestra formación y nuestra tarea profesional.
            </li>
          </ul>
          <p>
            En estos pilares nos apoyamos para desarrollar las actitudes
            personales y profesionales necesarias para crear condiciones que
            faciliten un vínculo humano en cada encuentro y el despliegue de la
