    ...
    <main className="counseling-cont container">
      ...
      <div className="counseling-info-cont">
        <div className="counseling-text-cont">
          <p>
            El Counseling es una profesión para el desarrollo y el despliegue de
          ...
          <p>
            El counseling crea condiciones que faciltan la expresion de la
            persona. Trabajando con el vinculo humano, en un espacio de
          ...
          <p>
            ...
            proceso pueda: reconocerse así misma con sus necesidades y hacer
            frente a ellas, poniendo al servicio sus recursos internos y sus
            herramientas personales; desarrollar y desplegar sus capacidades;
            ...
            plenamente; mejorar su calidad de vida, sus vínculos, sus relaciones
            con el mundo; desenvolverse creativamente; habilitarse a transitar
            la vida desplegando todo su ser, deseando, sintiendo, pensando,
            haciendo, creando.
          </p>
          <p>
            ...
            presente. Para que se permita expresar en un ambiente de seguridad,
            de respeto, de comprensión.
          </p>
          <p>
            Una de las ventajas importantes del trabajo en tiempo presente, es
            la posibilidad de Resignificar situaciones pasadas, es decir de
          ...
          <p>
            Desde el counseling realizamos un acompañamiento de la persona, como
            una realidad compleja y única, intentando acercarnos a su vivencia
            particular. Y desde este lugar trabajamos con ella, en las
